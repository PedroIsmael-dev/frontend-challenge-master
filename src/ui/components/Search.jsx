...
const Search = ({ search, handleChange }) => {
    return (
        <div class="relative flex flex-wrap items-stretch ml-auto">
            ...
            <input value={ search } type="text" placeholder="Search" class="px-2 py-2 placeholder-gray-400 text-gray-600 relative bg-white bg-white rounded text-sm border border-gray-400 outline-none focus:outline-none focus:ring w-full pl-10" onChange={ handleChange }/>
        </div>
    );
}
